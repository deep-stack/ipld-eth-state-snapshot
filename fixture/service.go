...
var TxChainBlock45_Header = types.Header{
	ParentHash:  common.HexToHash("0x26b511b96146b8b32efa16557b6a0e07751d91663b3e0bd664aa0e5d58911276"),
	UncleHash:   common.HexToHash("0x1dcc4de8dec75d7aab85b567b6ccd41ad312451b948a7413f0a142fd40d49347"),
	Coinbase:    common.HexToAddress("0x0000000000000000000000000000000000000000"),
	Root:        common.HexToHash("0x7d1adaf24ad104819d95e3fe5cbfb3e9248ac9a7ce3e025fe7255ab95be287e5"),
	TxHash:      common.HexToHash("0x56e81f171bcc55a6ff8345e692c0f86e5b48e01b996cadc001622fb5e363b421"),
	ReceiptHash: common.HexToHash("0x56e81f171bcc55a6ff8345e692c0f86e5b48e01b996cadc001622fb5e363b421"),
	Bloom:       types.Bloom{},
	Difficulty:  big.NewInt(+2),
	Number:      big.NewInt(+int64(TxChainSnapshotHeight)),
	GasLimit:    8359154,
	GasUsed:     0,
	Time:        1656566903,
	Extra:       []byte{216, 131, 1, 10, 19, 132, 103, 101, 116, 104, 136, 103, 111, 49, 46, 49, 56, 46, 51, 133, 108, 105, 110, 117, 120, 0, 0, 0, 0, 0, 0, 0, 189, 124, 3, 197, 110, 247, 156, 13, 206, 187, 207, 246, 160, 111, 27, 126, 207, 23, 125, 253, 251, 123, 164, 247, 26, 133, 35, 197, 112, 12, 93, 200, 3, 9, 159, 30, 168, 143, 2, 201, 224, 52, 43, 113, 97, 162, 53, 126, 106, 178, 143, 211, 45, 167, 190, 155, 157, 153, 157, 16, 66, 83, 183, 241, 0},
	MixDigest:   common.Hash{},
	Nonce:       types.BlockNonce{},
	BaseFee:     nil,
}
